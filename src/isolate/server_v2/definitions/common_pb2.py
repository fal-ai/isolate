...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _LOGSOURCE._serialized_start = 284
    _LOGSOURCE._serialized_end = 330
    _LOGLEVEL._serialized_start = 332
    _LOGLEVEL._serialized_end = 422
    _SERIALIZEDOBJECT._serialized_start = 16
    _SERIALIZEDOBJECT._serialized_end = 93
    _PARTIALRUNRESULT._serialized_start = 95
    _PARTIALRUNRESULT._serialized_end = 204
    _LOG._serialized_start = 206
