...
class BoundFunction(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["_setup_func", b"_setup_func", "_teardown_func", b"_teardown_func", "environments", b"environments", "function", b"function", "setup_func", b"setup_func", "stream_logs", b"stream_logs", "teardown_func", b"teardown_func"]) -> None: ...
    @typing.overload
